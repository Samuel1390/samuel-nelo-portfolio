export function IconContainer({ projectIcon = false, children, name }) {
  return (
    <div
      className={`${name} ${projectIcon ? "project-icon-container" : "icon-container"}`}
    >
      {children /*SVG aqui*/}
      <h3 className="first-letter:uppercase">
        {name === "nextjs" ? "next.js" : name}
      </h3>
    </div>
  );
}
export function HtmlSvg({ className = "tech-icon" }) {
  return (
    <svg
      className={className}
...
export function CssSvg({ className = "tech-icon" }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function GitSvg({ className = "tech-icon" }) {
  return (
...
export function JsSvg({ className = "tech-icon" }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function GithubSvg({ className = "tech-icon" }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function ReactSvg({ className = "tech-icon" }) {
  return (
    <svg
      className={className}
...
export function TailwindSvg({ className = "tech-icon" }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const NextSvg = ({ className = "tech-icon" }) => {
  return (
    <svg
      width={20}
      viewBox="0 0 128 128"
...
export const TypescriptSvg = ({ className = "tech-icon" }) => {
  return (
    <svg
      width="25"
      height="25"
    ...
    >
      ...
      <path
        d="M1876.1 1900.5C1821 2004.1 1699.5 2049.1 1583.5 2011.6C1518.3 1990.4 1466.9 1940.3 1439.4 1877.3L1594 1785.4C1613.5 1832.2 1653.6 1863.5 1701.2 1868.5C1753.8 1872.9 1802.7 1845.3 1821.5 1797.1C1835.3 1759.5 1821.5 1716.9 1787.7 1695.6C1757.7 1675.6 1618.6 1616.7 1559.7 1591.7C1448.3 1544.1 1386.9 1423.9 1417 1306.2C1442 1211 1519.6 1139.7 1614.8 1124.6C1717.5 1109.6 1818.9 1152.1 1872.8 1239.8C1909.1 1298.7 1925.4 1367.6 1917.9 1436.5L1763.2 1436.5C1765.7 1391.4 1753.2 1346.3 1726.9 1311.2C1693.1 1264.9 1629.2 1253.6 1581.6 1284.9C1549.1 1307.5 1537.8 1348.8 1554.1 1385.1C1571.6 1421.4 1612.9 1440.2 1711.9 1481.5C1818.3 1526.6 1894.7 1620.5 1909.8 1735.7C1919.8 1794.5 1908.5 1853.4 1876.1 1900.5Z"
        fill="white"
      />
      <path
        d="M1175.7 1139.7V1284.9H942.8V1999.2H785V1284.9H553.4V1139.7H1175.7Z"
        fill="white"
      />
    </svg>
  );
